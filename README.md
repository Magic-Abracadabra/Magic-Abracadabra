...
2. “去中心化”完全局限于*工程特征与技术手段*，是手段不是目的——我们刻意将我们的“去中心化”与其背后的一切政治口号和意识形态划清界限——信念的纯粹，是我们力量的源泉；模糊这条界线，就是稀释我们的使命
...
We are a small team whose members major in Mathematics & Engineering, with limited resources (esp. equipment and computational resources). This is why we consecrate ourselves to the advent of a decentralized (Remark: We have defined the term "decentralized" above in Chinese) world.
...
## 我们内部的技术新秩序：从中心化到去中心化生态
* 技术平权：智能可以在普通个人电脑甚至手机上本地训练和部署——智能不再是少数人的特权
* 完全掌控：数据不出设备，推理过程完全自主掌控——用户甚至可以自己亲手复现这样的智能模型/智能体
* 极致稳健的决策系统：系统不会因中心服务器故障而瘫痪——每个个体都可以发挥自身影响力并在分析阶段提供独一无二的视野，群体即可掌握全局、缩小盲点对冲决策风险，在综合决策与压力测试阶段产生最佳战略——我们追求创意择优，不在乎最佳决策源于何处，我们在乎是否扫清了盲区；我们反对针对我们内部成员的个人崇拜，这不利于消除集体盲点，这不利于集体的稳健可持续发展
* 开放与可控：早期模型和框架开源，促进协作与创新；同时核心安全机制闭源，防止滥用和被控制。用户真正拥有对自己智能的完全控制权，最终决策权和控制权在你手中，人类才是最终的裁判，借助智能扬长避短

## 我们内部的就业新秩序：我们如何找到同道中人，你就的是这份事业与使命——从替代与焦虑到协作与创造
...
<a href="https://cloud.tencent.com/developer/user/11279262" title="腾讯云"><img src="https://img2.baidu.com/it/u=1728893410,1862478101&fm=253&fmt=auto&app=138&f=PNG?w=500&h=500" alt="腾讯云" title="腾讯云" width="20"></a>

## 我们内部的教育新秩序：如何共同启迪与成长——教师和孩子也可以成为人类文明的守护者（类似元数学领域的逆向数学）
